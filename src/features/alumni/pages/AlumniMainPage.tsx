...
// Tab types
type PrimaryTab = 'directory' | 'batches' | 'achievements' | 'contributions' | 'events'
            ...
            return (
              <Card key={batch.batch} className="hover:shadow-md transition-shadow">
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* View Link */}
                  <Link
                    to={`/alumni?tab=directory&batch=${batch.batch}`}
...
// ============================================
// Main AlumniMainPage Component
// ============================================
export function AlumniMainPage() {
  const [searchParams, setSearchParams] = useSearchParams()

  // Primary tab
  const activeTab = (searchParams.get('tab') as PrimaryTab) || 'directory'
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Manage alumni database, achievements, contributions, and events"
